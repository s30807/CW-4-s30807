...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var chicagoList = depts.Where(d => d.Loc.Equals("CHICAGO")).Select(d => d.DeptNo);
        List<Emp> result = emps.Where(e => chicagoList.Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        var emps = Database.GetEmps();
         ...
         var result = emps.GroupBy(e => e.DeptNo).Select(g => new { DeptNo = g.Key, Count = g.Count() });
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e => e.Comm != null).SelectMany(e => e.EName, (e, c) => new { Ename = e.EName, Comm = e.Comm });
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        var emps = Database.GetEmps();
         ...
         var result = emps.GroupBy(e => e.DeptNo).Select(obj => new {DeptNo = obj.Key, AvgSal = obj.Average(e => e.Sal)}).ToList();
